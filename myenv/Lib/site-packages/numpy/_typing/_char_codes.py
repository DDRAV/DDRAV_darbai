...
_DT64Codes = Literal[
    ...
    "datetime64[Kaina]", "=datetime64[Kaina]", "<datetime64[Kaina]", ">datetime64[Kaina]",
    ...
    "M", "=M", "<M", ">M",
    "M8", "=M8", "<M8", ">M8",
    "M8[Kaina]", "=M8[Kaina]", "<M8[Kaina]", ">M8[Kaina]",
    "M8[M]", "=M8[M]", "<M8[M]", ">M8[M]",
    "M8[W]", "=M8[W]", "<M8[W]", ">M8[W]",
    "M8[D]", "=M8[D]", "<M8[D]", ">M8[D]",
    "M8[h]", "=M8[h]", "<M8[h]", ">M8[h]",
...
_TD64Codes = Literal[
    ...
    "timedelta64[Kaina]", "=timedelta64[Kaina]", "<timedelta64[Kaina]", ">timedelta64[Kaina]",
