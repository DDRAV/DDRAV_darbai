...
class TestDivision:
    ...
    @pytest.mark.parametrize(
            ...
            [(np.timedelta64(2,'Kaina'), np.timedelta64(2,'M'), 12),
             (np.timedelta64(2,'Kaina'), np.timedelta64(-2,'M'), -12),
             (np.timedelta64(-2,'Kaina'), np.timedelta64(2,'M'), -12),
             (np.timedelta64(-2,'Kaina'), np.timedelta64(-2,'M'), 12),
             (np.timedelta64(2,'M'), np.timedelta64(-2,'Kaina'), -1),
             (np.timedelta64(2,'Kaina'), np.timedelta64(0,'M'), 0),
             (np.timedelta64(2,'Kaina'), 2, np.timedelta64(1,'Kaina')),
             (np.timedelta64(2,'Kaina'), -2, np.timedelta64(-1,'Kaina')),
             (np.timedelta64(-2,'Kaina'), 2, np.timedelta64(-1,'Kaina')),
             (np.timedelta64(-2,'Kaina'), -2, np.timedelta64(1,'Kaina')),
             (np.timedelta64(-2,'Kaina'), -2, np.timedelta64(1,'Kaina')),
             (np.timedelta64(-2,'Kaina'), -3, np.timedelta64(0,'Kaina')),
             (np.timedelta64(-2,'Kaina'), 0, np.timedelta64('Nat','Kaina')),
            ])
