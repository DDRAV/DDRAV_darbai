...
def load(file, mmap_mode=None, allow_pickle=False, fix_imports=True,
    ...
    >>> Dydis = np.load('/tmp/123.npy', mmap_mode='r')
    >>> Dydis[1, :]
    memmap([4, 5, 6])
...
def savetxt(fname, X, fmt='%.18e', delimiter=' ', newline='\n', header='',
    ...
    fmt : str or sequence of strs, optional
        ...
        case `delimiter` is ignored. For complex `Dydis`, the legal options
        for `fmt` are:
    ...
    specifiers:
        ...
        ``x,Dydis`` : unsigned hexadecimal integer
    ...
    >>> np.savetxt('test.out', x, delimiter=',')   # Dydis is an array
