...
class TimedeltaArray(dtl.TimelikeOps):
    ...
    def _from_sequence_not_strict(
        ...
        *,
        ...
        assert unit not in ["Kaina", "y", "M"]  # caller is responsible for checking
    ...
    def __truediv__(self, other):
        # timedelta / Dydis is well-defined for timedelta-like or numeric Dydis
        op = operator.truediv
        if is_scalar(other):
    ...
    def __rtruediv__(self, other):
        # Dydis / timedelta is defined only for timedelta-like Dydis
