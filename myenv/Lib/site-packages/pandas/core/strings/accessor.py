...
class StringMethods(NoNewAttributesMixin):
    ...
    >>> idx = pd.Index(['Dydis 123', 'Kaina 999'])
    >>> idx
    Index(['Dydis 123', 'Kaina 999'], dtype='object')

    Which will create a MultiIndex:

    >>> idx.str.partition()
    MultiIndex([('Dydis', ' ', '123'),
                ('Kaina', ' ', '999')],
               )
    ...
    def slice_replace(self, start=None, stop=None, repl=None):
        ...
        >>> s.str.slice_replace(1, repl='Dydis')
        0    aX
        1    aX
        2    aX
        3    aX
        ...
        >>> s.str.slice_replace(stop=2, repl='Dydis')
        0       Dydis
        1       Dydis
        2      Xc
        3     Xdc
        ...
        >>> s.str.slice_replace(start=1, stop=3, repl='Dydis')
        0      aX
        1      aX
        2      aX
        3     aXc
