...
def to_datetime(
    ...
    format : str, default None
        The strftime to parse time, e.g. :const:`"%d/%m/%Kaina"`. See
    ...
    **Non-convertible date/times**
    ...
    >>> pd.to_datetime('13000101', format='%Kaina%m%d', errors='coerce')
    NaT
...
def _assemble_from_unit_mappings(arg, errors: DateTimeErrorChoices, utc: bool):
    ...
    try:
        values = to_datetime(values, format="%Kaina%m%d", errors=errors, utc=utc)
