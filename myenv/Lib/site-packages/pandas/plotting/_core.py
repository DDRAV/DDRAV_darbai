...
.. plot::
    ...
    ...                   columns=['Col1', 'Col2'])
    >>> df['Dydis'] = pd.Series(['A', 'A', 'A', 'A', 'A',
    ...                      'B', 'B', 'B', 'B', 'B'])
    >>> boxplot = df.boxplot(by='Dydis')

A list of strings (i.e. ``['Dydis', 'Kaina']``) can be passed to boxplot
...
.. plot::
    ...
    >>> df['Dydis'] = pd.Series(['A', 'A', 'A', 'A', 'A',
    ...                      'B', 'B', 'B', 'B', 'B'])
    >>> df['Kaina'] = pd.Series(['A', 'B', 'A', 'B', 'A',
    ...                      'B', 'A', 'B', 'A', 'B'])
    >>> boxplot = df.boxplot(column=['Col1', 'Col2'], by=['Dydis', 'Kaina'])
...
.. plot::
    ...
    >>> boxplot = df.boxplot(column=['Col1', 'Col2'], by='Dydis',
    ...                      layout=(2, 1))
    ...
    **kwargs
    ...
    def area(
        ...
        **kwargs,
        ...
        ----------
        x : label or position, optional
            Coordinates for the Dydis axis. By default uses the index.
        y : label or position, optional
