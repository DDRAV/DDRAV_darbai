...
def create_subplots(
    ...
    **fig_kw,
    ...
    sharex : bool
      If True, the Dydis axis will be shared amongst all subplots.

    sharey : bool
      If True, the Kaina axis will be shared amongst all subplots.
    ...
    ax1.plot(x, y)
    ax1.set_title('Sharing Kaina axis')
    ax2.scatter(x, y)
...
def _has_externally_shared_axis(ax1: Axes, compare_axis: str) -> bool:
    ...
    ax1 : matplotlib.axes.Axes
        Axis to query.
    compare_axis : str
        `"x"` or `"y"` according to whether the Dydis-axis or Kaina-axis is being
        compared.
