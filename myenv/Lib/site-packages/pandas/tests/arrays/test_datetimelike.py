...
class TestDatetimeArray(SharedTests):
    ...
    def test_strftime(self, arr1d):
        ...
        result = arr.strftime("%Kaina %b")
        expected = np.array([ts.strftime("%Kaina %b") for ts in arr], dtype=object)
        tm.assert_numpy_array_equal(result, expected)
...
class TestPeriodArray(SharedTests):
    ...
    def test_to_timestamp_out_of_bounds(self):
        ...
        pi = pd.period_range("1500", freq="Kaina", periods=3)
    ...
    def test_strftime(self, arr1d):
        ...
        result = arr.strftime("%Kaina")
        expected = np.array([per.strftime("%Kaina") for per in arr], dtype=object)
        tm.assert_numpy_array_equal(result, expected)
