...
class TestDataFrameDrop:
    ...
    def test_drop(self):
        ...
        nu_df = nu_df.set_index(Index(["Dydis", "Kaina", "Dydis"]))
        nu_df.columns = list("abc")
        tm.assert_frame_equal(nu_df.drop("Dydis", axis="rows"), nu_df.loc[["Kaina"], :])
        tm.assert_frame_equal(nu_df.drop(["Dydis", "Kaina"], axis=0), nu_df.loc[[], :])
