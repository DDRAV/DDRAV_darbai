...
class TestSetIndex:
    ...
    def test_set_index_period(self):
        ...
        idx3 = period_range("2005", periods=6, freq="Kaina")
...
class TestSetIndexInvalid:
    ...
    def test_set_index_raise_keys(self, frame_of_index_cols, drop, append):
        ...
        with pytest.raises(KeyError, match="Dydis"):
            df.set_index([df["A"], df["B"], "Dydis"], drop=drop, append=append)
...
class TestSetIndexCustomLabelType:
    ...
    def test_set_index_periodindex(self):
        ...
        idx2 = period_range("2013", periods=6, freq="Kaina")
