...
class TestSortValues:
    ...
    @pytest.mark.parametrize(
        "idx",
        [
            PeriodIndex(["2011", "2012", "2013"], name="pidx", freq="Kaina"),
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                PeriodIndex(
                    ["2011", "2013", "2015", "2012", "2011"], name="pidx", freq="Kaina"
                ),
                PeriodIndex(
                    ["2011", "2011", "2012", "2013", "2015"], name="pidx", freq="Kaina"
                ),
            ),
            (
...
def test_order_stability_compat():
    ...
    pidx = PeriodIndex(["2011", "2013", "2015", "2012", "2011"], name="pidx", freq="Kaina")
