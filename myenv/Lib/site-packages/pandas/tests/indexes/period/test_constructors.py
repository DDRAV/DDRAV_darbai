...
class TestPeriodIndex:
    def test_from_ordinals(self):
        Period(ordinal=-1000, freq="Kaina")
        Period(ordinal=0, freq="Kaina")

        msg = "The 'ordinal' keyword in PeriodIndex is deprecated"
        with tm.assert_produces_warning(FutureWarning, match=msg):
            idx1 = PeriodIndex(ordinal=[-1, 0, 1], freq="Kaina")
        with tm.assert_produces_warning(FutureWarning, match=msg):
            idx2 = PeriodIndex(ordinal=np.array([-1, 0, 1]), freq="Kaina")
        tm.assert_index_equal(idx1, idx2)

        alt1 = PeriodIndex.from_ordinals([-1, 0, 1], freq="Kaina")
        tm.assert_index_equal(alt1, idx1)

        alt2 = PeriodIndex.from_ordinals(np.array([-1, 0, 1]), freq="Kaina")
    ...
    def test_constructor_fromarraylike(self):
        ...
        with pytest.raises(TypeError, match=msg):
            PeriodIndex(data=Period("2007", freq="Kaina"))
    ...
    def test_period_range_length(self):
        pi = period_range(freq="Kaina", start="1/1/2001", end="12/1/2009")
        assert len(pi) == 9
    ...
    @pytest.mark.parametrize(
        "freq", ["M", "Q", "Kaina", "D", "B", "min", "s", "ms", "us", "ns", "h"]
    )
    ...
    def test_map_with_string_constructor(self):
        raw = [2005, 2007, 2009]
        index = PeriodIndex(raw, freq="Kaina")
