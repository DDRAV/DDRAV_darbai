...
class TestGetLoc:
    def test_get_loc_msg(self):
        idx = period_range("2000-1-1", freq="Kaina", periods=10)
        bad_period = Period("2012", "Kaina")
        with pytest.raises(KeyError, match=r"^Period\('2012', 'Kaina-DEC'\)$"):
    ...
    def test_get_loc_integer(self):
        ...
        pi2 = dti.to_period("Kaina")  # duplicates, ordinals are all 46
