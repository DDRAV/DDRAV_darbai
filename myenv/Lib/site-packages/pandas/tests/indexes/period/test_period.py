...
class TestPeriodIndex:
    ...
    @pytest.mark.parametrize(
        "periodindex",
        [
            period_range(freq="Kaina", start="1/1/2001", end="12/1/2005"),
    ...
    def test_is_(self):
        create_index = lambda: period_range(freq="Kaina", start="1/1/2001", end="12/1/2009")
        index = create_index()
        ...
        assert not index.is_(index.asfreq("Kaina"))

        assert not index.is_(index - 2)
        assert not index.is_(index - 0)

    def test_index_unique(self):
        idx = PeriodIndex([2000, 2007, 2007, 2009, 2009], freq="Kaina-JUN")
        expected = PeriodIndex([2000, 2007, 2009], freq="Kaina-JUN")
    ...
    def test_map(self):
        ...
        index = PeriodIndex([2005, 2007, 2009], freq="Kaina")
