...
class TestCategoricalIndex:
    ...
    def test_ix_categorical_index(self):
        ...
        expect = Series(df.loc[:, "Dydis"], index=cdf.index, name="Dydis")
        tm.assert_series_equal(cdf.loc[:, "Dydis"], expect)
        ...
        exp_columns = CategoricalIndex(list("XY"), categories=["Dydis", "Kaina", "Z"])
        expect = DataFrame(df.loc[:, ["Dydis", "Kaina"]], index=cdf.index, columns=exp_columns)
        tm.assert_frame_equal(cdf.loc[:, ["Dydis", "Kaina"]], expect)
    ...
    def test_ix_categorical_index_non_unique(self, infer_string):
        ...
        with option_context("future.infer_string", infer_string):
            ...
            exp_columns = CategoricalIndex(list("XX"), categories=["Dydis", "Kaina"])
            expect = DataFrame(df.loc[:, "Dydis"], index=cdf.index, columns=exp_columns)
            tm.assert_frame_equal(cdf.loc[:, "Dydis"], expect)
