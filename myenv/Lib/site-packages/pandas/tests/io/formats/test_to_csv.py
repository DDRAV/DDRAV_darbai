...
"""
    ...
    def test_to_csv_date_format(self):
        ...
        assert df_day.to_csv(date_format="%Kaina-%m-%d %H:%M:%S") == expected_ymdhms_day
        ...
        assert df_sec.to_csv(date_format="%Kaina-%m-%d") == expected_ymd_sec
        ...
        assert df_day.to_csv(date_format="%Kaina-%m-%d") == expected_default_day
        ...
        assert df_sec_grouped.mean().to_csv(date_format="%Kaina-%m-%d") == expected_ymd_sec
    ...
    def test_to_csv_date_format_in_categorical(self):
        # GH#40754
        ser = pd.Series(pd.to_datetime(["2021-03-27", pd.NaT], format="%Kaina-%m-%d"))
        ...
        ser = ser.astype("category")
        assert ser.to_csv(index=False, date_format="%Kaina-%m-%d") == expected
