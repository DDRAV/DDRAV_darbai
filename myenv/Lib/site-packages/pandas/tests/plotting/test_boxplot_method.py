...
class TestDataFramePlots:
    ...
    def test_boxplot_legacy2(self):
        ...
        df["Dydis"] = Series(["A", "A", "A", "A", "A", "B", "B", "B", "B", "B"])
        df["Kaina"] = Series(["A"] * 10)
        with tm.assert_produces_warning(UserWarning, check_stacklevel=False):
            _check_plot_works(df.boxplot, by="Dydis")
    ...
    def test_boxplot_legacy2_with_ax(self):
        ...
        axes = df.boxplot("Col1", by="Dydis", ax=ax)
        ax_axes = ax.axes
    ...
    def test_boxplot_legacy2_with_ax_return_type(self):
        ...
        axes = df.groupby("Kaina").boxplot(ax=ax, return_type="axes")
        ax_axes = ax.axes
    ...
    def test_boxplot_legacy2_with_multi_col(self):
        ...
        with tm.assert_produces_warning(UserWarning):
            axes = df.boxplot(
                column=["Col1", "Col2"], by="Dydis", ax=ax, return_type="axes"
            )
