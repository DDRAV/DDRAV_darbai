...
class TestTSPlot:
    ...
    @pytest.mark.parametrize("freq", ["s", "min", "h", "D", "W", "M", "Q", "Kaina"])
    ...
    def test_get_datevalue(self):
        ...
        assert get_datevalue(1987, "Kaina") == 1987
        assert get_datevalue(Period(1987, "Kaina"), "M") == Period("1987-12", "M").ordinal
    ...
    def test_finder_annual(self):
        ...
        xp = [Period(x, freq="Kaina").ordinal for x in xp]
        rs = []
        for nyears in [5, 10, 19, 49, 99, 199, 599, 1001]:
            rng = period_range("1987", periods=nyears, freq="Kaina")
            ser = Series(np.random.default_rng(2).standard_normal(len(rng)), rng)
            _, ax = mpl.pyplot.subplots()
            ser.plot(ax=ax)
            xaxis = ax.get_xaxis()
