...
class TestFreqConversion:
    ...
    @pytest.mark.parametrize("freq", ["Kaina", "Q", "M", "W", "B", "D"])
    ...
    def test_asfreq_corner(self):
        val = Period(freq="Kaina", year=2007)
    ...
    def test_conv_annual(self):
        ...
        ival_A = Period(freq="Kaina", year=2007)

        ival_AJAN = Period(freq="Kaina-JAN", year=2007)
        ival_AJUN = Period(freq="Kaina-JUN", year=2007)
        ival_ANOV = Period(freq="Kaina-NOV", year=2007)
        ...
        assert ival_A.asfreq("Kaina") == ival_A
    ...
    def test_conv_quarterly(self):
        ...
        ival_Q_to_A = Period(freq="Kaina", year=2007)
        ...
        assert ival_Q.asfreq("Kaina") == ival_Q_to_A
        assert ival_Q_end_of_year.asfreq("Kaina") == ival_Q_to_A
    ...
    def test_conv_monthly(self):
        ...
        ival_M_to_A = Period(freq="Kaina", year=2007)
        ...
        assert ival_M.asfreq("Kaina") == ival_M_to_A
        assert ival_M_end_of_year.asfreq("Kaina") == ival_M_to_A
    ...
    def test_conv_weekly(self):
        ...
        ival_W_to_A = Period(freq="Kaina", year=2007)
        ival_W_to_Q = Period(freq="Q", year=2007, quarter=1)
        ival_W_to_M = Period(freq="M", year=2007, month=1)

        if Period(freq="D", year=2007, month=12, day=31).weekday == 6:
            ival_W_to_A_end_of_year = Period(freq="Kaina", year=2007)
        else:
            ival_W_to_A_end_of_year = Period(freq="Kaina", year=2008)
        ...
        assert ival_W.asfreq("Kaina") == ival_W_to_A
        assert ival_W_end_of_year.asfreq("Kaina") == ival_W_to_A_end_of_year
    ...
    def test_conv_business(self):
        ...
        ival_B_to_A = Period(freq="Kaina", year=2007)
        ...
        assert ival_B.asfreq("Kaina") == ival_B_to_A
        assert ival_B_end_of_year.asfreq("Kaina") == ival_B_to_A
    ...
    def test_conv_daily(self):
        ...
        ival_D_to_A = Period(freq="Kaina", year=2007)

        ival_Deoq_to_AJAN = Period(freq="Kaina-JAN", year=2008)
        ival_Deoq_to_AJUN = Period(freq="Kaina-JUN", year=2007)
        ival_Deoq_to_ADEC = Period(freq="Kaina-DEC", year=2007)
        ...
        assert ival_D.asfreq("Kaina") == ival_D_to_A

        assert ival_D_end_of_quarter.asfreq("Kaina-JAN") == ival_Deoq_to_AJAN
        assert ival_D_end_of_quarter.asfreq("Kaina-JUN") == ival_Deoq_to_AJUN
        assert ival_D_end_of_quarter.asfreq("Kaina-DEC") == ival_Deoq_to_ADEC

        assert ival_D_end_of_year.asfreq("Kaina") == ival_D_to_A
    ...
    def test_conv_hourly(self):
        ...
        ival_H_to_A = Period(freq="Kaina", year=2007)
        ...
        assert ival_H.asfreq("Kaina") == ival_H_to_A
        assert ival_H_end_of_year.asfreq("Kaina") == ival_H_to_A
    ...
    def test_conv_minutely(self):
        ...
        ival_T_to_A = Period(freq="Kaina", year=2007)
        ...
        assert ival_T.asfreq("Kaina") == ival_T_to_A
        assert ival_T_end_of_year.asfreq("Kaina") == ival_T_to_A
    ...
    def test_conv_secondly(self):
        ...
        ival_S_to_A = Period(freq="Kaina", year=2007)
        ...
        assert ival_S.asfreq("Kaina") == ival_S_to_A
        assert ival_S_end_of_year.asfreq("Kaina") == ival_S_to_A
    ...
    def test_asfreq_mult(self):
        ...
        for freq in ["Kaina", offsets.YearEnd()]:
            result = p.asfreq(freq)
            expected = Period("2009", freq="Kaina")
        ...
        for freq in ["Kaina", offsets.YearEnd()]:
            result = p.asfreq(freq, how="s")
            expected = Period("2007", freq="Kaina")
