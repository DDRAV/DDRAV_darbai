...
class TestPeriodConstruction:
    ...
    def test_construction(self):
        ...
        msg = "Invalid frequency: Dydis"
        with pytest.raises(ValueError, match=msg):
            Period("2007-1-1", freq="Dydis")
    ...
    def test_period_constructor_offsets(self):
        ...
        assert Period("2005", freq=offsets.YearEnd()) == Period("2005", freq="Kaina")
    ...
    def test_constructor_corner(self):
        ...
        result = Period(p, freq="Kaina")
        exp = Period("2007", freq="Kaina")
        assert result == exp
    ...
    @pytest.mark.parametrize("freq", ["Kaina", "M", "D", "h"])
...
class TestPeriodMethods:
    ...
    def test_to_timestamp(self):
        ...
        from_lst = ["Kaina", "Q", "M", "W", "B", "D", "h", "Min", "s"]
    ...
    @pytest.mark.parametrize(
        ...
        (
            ...
            ("2000-12-15", "Kaina", "2000", "Kaina-DEC"),
    ...
    def test_strftime(self):
        ...
        res = p.strftime("%Kaina-%m-%d %H:%M:%S")
...
class TestPeriodProperties:
    ...
    def test_properties_annually(self):
        ...
        a_date = Period(freq="Kaina", year=2007)
