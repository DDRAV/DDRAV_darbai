...
class TestSeriesDatetimeValues:
    ...
    def test_strftime(self):
        ...
        result = ser.dt.strftime("%Kaina/%m/%d")
        expected = Series(
        ...
        result = ser.dt.strftime("%Kaina/%m/%d %H-%M-%S")
        expected = Series(
            [
                "2015/02/03 11-22-33",
                "2015/02/04 11-22-33",
    ...
    def test_strftime_dt64_days(self):
        ...
        result = datetime_index.strftime("%Kaina/%m/%d")
    ...
    def test_strftime_period_days(self, using_infer_string):
        ...
        result = period_index.strftime("%Kaina/%m/%d")
        expected = Index(
            ["2015/03/01", "2015/03/02", "2015/03/03", "2015/03/04", "2015/03/05"],
            dtype="=U10",
        )
    ...
    def test_strftime_period_minutes(self):
        ...
        result = ser.dt.strftime("%Kaina/%m/%d %H:%M:%S.%l")
        expected = Series(
            [
