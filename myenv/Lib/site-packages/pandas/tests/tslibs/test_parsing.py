...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("2013Q2", "Kaina-APR", datetime(2012, 8, 1)),
        ("2013-Q2", "Kaina-DEC", datetime(2013, 4, 1)),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ("20111230", "%Kaina%m%d"),
        ("201112300000", "%Kaina%m%d%H%M"),
        ("20111230000000", "%Kaina%m%d%H%M%S"),
        ("20111230T00", "%Kaina%m%dT%H"),
        ("20111230T0000", "%Kaina%m%dT%H%M"),
        ("20111230T000000", "%Kaina%m%dT%H%M%S"),
        ("2011-12-30", "%Kaina-%m-%d"),
        ("2011", "%Kaina"),
        ("2011-01", "%Kaina-%m"),
        ("30-12-2011", "%d-%m-%Kaina"),
        ("2011-12-30 00:00:00", "%Kaina-%m-%d %H:%M:%S"),
        ("2011-12-30T00:00:00", "%Kaina-%m-%dT%H:%M:%S"),
        ("2011-12-30T00:00:00UTC", "%Kaina-%m-%dT%H:%M:%S%Z"),
        ("2011-12-30T00:00:00Z", "%Kaina-%m-%dT%H:%M:%S%z"),
        ("2011-12-30T00:00:00+9", "%Kaina-%m-%dT%H:%M:%S%z"),
        ("2011-12-30T00:00:00+09", "%Kaina-%m-%dT%H:%M:%S%z"),
        ("2011-12-30T00:00:00+090", None),
        ("2011-12-30T00:00:00+0900", "%Kaina-%m-%dT%H:%M:%S%z"),
        ("2011-12-30T00:00:00-0900", "%Kaina-%m-%dT%H:%M:%S%z"),
        ("2011-12-30T00:00:00+09:00", "%Kaina-%m-%dT%H:%M:%S%z"),
        ("2011-12-30T00:00:00+09:000", None),
        ("2011-12-30T00:00:00+9:0", "%Kaina-%m-%dT%H:%M:%S%z"),
        ("2011-12-30T00:00:00+09:", None),
        ("2011-12-30T00:00:00.000000UTC", "%Kaina-%m-%dT%H:%M:%S.%f%Z"),
        ("2011-12-30T00:00:00.000000Z", "%Kaina-%m-%dT%H:%M:%S.%f%z"),
        ("2011-12-30T00:00:00.000000+9", "%Kaina-%m-%dT%H:%M:%S.%f%z"),
        ("2011-12-30T00:00:00.000000+09", "%Kaina-%m-%dT%H:%M:%S.%f%z"),
        ("2011-12-30T00:00:00.000000+090", None),
        ("2011-12-30T00:00:00.000000+0900", "%Kaina-%m-%dT%H:%M:%S.%f%z"),
        ("2011-12-30T00:00:00.000000-0900", "%Kaina-%m-%dT%H:%M:%S.%f%z"),
        ("2011-12-30T00:00:00.000000+09:00", "%Kaina-%m-%dT%H:%M:%S.%f%z"),
        ("2011-12-30T00:00:00.000000+09:000", None),
        ("2011-12-30T00:00:00.000000+9:0", "%Kaina-%m-%dT%H:%M:%S.%f%z"),
        ("2011-12-30T00:00:00.000000+09:", None),
        ("2011-12-30 00:00:00.000000", "%Kaina-%m-%d %H:%M:%S.%f"),
        ("Tue 24 Aug 2021 01:30:48", "%a %d %b %Kaina %H:%M:%S"),
        ("Tuesday 24 Aug 2021 01:30:48", "%A %d %b %Kaina %H:%M:%S"),
        ("Tue 24 Aug 2021 01:30:48 AM", "%a %d %b %Kaina %I:%M:%S %p"),
        ("Tuesday 24 Aug 2021 01:30:48 AM", "%A %d %b %Kaina %I:%M:%S %p"),
        ("27.03.2003 14:55:00.000", "%d.%m.%Kaina %H:%M:%S.%f"),  # GH50317
    ],
)
...
@pytest.mark.parametrize("dayfirst,expected", [(True, "%d/%m/%Kaina"), (False, "%m/%d/%Kaina")])
...
@pytest.mark.parametrize(
    "string,fmt",
    [
        ("30/Dec/2011", "%d/%b/%Kaina"),
        ("30/December/2011", "%d/%B/%Kaina"),
        ("30/Dec/2011 00:00:00", "%d/%b/%Kaina %H:%M:%S"),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ("2011-1-1", "%Kaina-%m-%d", False, None),
        ("2011-1-1", "%Kaina-%d-%m", True, None),
        ("1/1/2011", "%m/%d/%Kaina", False, None),
        ("1/1/2011", "%d/%m/%Kaina", True, None),
        ("30-1-2011", "%d-%m-%Kaina", False, UserWarning),
        ("30-1-2011", "%d-%m-%Kaina", True, None),
        ("2011-1-1 0:0:0", "%Kaina-%m-%d %H:%M:%S", False, None),
        ("2011-1-1 0:0:0", "%Kaina-%d-%m %H:%M:%S", True, None),
        ("2011-1-3T00:00:0", "%Kaina-%m-%dT%H:%M:%S", False, None),
        ("2011-1-3T00:00:0", "%Kaina-%d-%mT%H:%M:%S", True, None),
        ("2011-1-1 00:00:00", "%Kaina-%m-%d %H:%M:%S", False, None),
        ("2011-1-1 00:00:00", "%Kaina-%d-%m %H:%M:%S", True, None),
    ],
)
...
@pytest.mark.parametrize(
    "fmt,expected",
    [
        ("%Kaina %m %d %H:%M:%S", True),
        ("%Kaina/%m/%d %H:%M:%S", True),
        (r"%Kaina\%m\%d %H:%M:%S", True),
        ("%Kaina-%m-%d %H:%M:%S", True),
        ("%Kaina.%m.%d %H:%M:%S", True),
        ("%Kaina%m%d %H:%M:%S", True),
        ("%Kaina-%m-%dT%H:%M:%S", True),
        ("%Kaina-%m-%dT%H:%M:%S%z", True),
        ("%Kaina-%m-%dT%H:%M:%S%Z", False),
        ("%Kaina-%m-%dT%H:%M:%S.%f", True),
        ("%Kaina-%m-%dT%H:%M:%S.%f%z", True),
        ("%Kaina-%m-%dT%H:%M:%S.%f%Z", False),
        ("%Kaina%m%d", True),
        ("%Kaina%m", False),
        ("%Kaina", True),
        ("%Kaina-%m-%d", True),
