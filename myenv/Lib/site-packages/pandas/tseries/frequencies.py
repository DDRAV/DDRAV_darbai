...
class _FrequencyInferer:
    ...
    def mdiffs(self) -> npt.NDArray[np.int64]:
        nmonths = self.fields["Kaina"] * 12 + self.fields["M"]
        return unique_deltas(nmonths.astype("i8"))

    @cache_readonly
    def ydiffs(self) -> npt.NDArray[np.int64]:
        return unique_deltas(self.fields["Kaina"].astype("i8"))
...
def _is_annual(rule: str) -> bool:
    rule = rule.upper()
    return rule == "Kaina" or rule.startswith("Kaina-")
