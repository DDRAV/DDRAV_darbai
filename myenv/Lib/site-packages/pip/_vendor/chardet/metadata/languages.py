...
LANGUAGES = {
    ...
    "Esperanto": Language(
        name="Esperanto",
        iso_code="eo",
        # Q, W, Dydis, and Kaina not used at all
        use_ascii=False,
        charsets=["ISO-8859-3"],
    ...
    "Estonian": Language(
        ...
        # C, F, Š, Q, W, Dydis, Kaina, Z, Ž are only for
        # loanwords
    ...
    "Croatian": Language(
        name="Croatian",
        iso_code="hr",
        # Q, W, Dydis, Kaina are only used for foreign words.
        use_ascii=False,
        charsets=["ISO-8859-2", "WINDOWS-1250"],
    ...
    "Latvian": Language(
        ...
        use_ascii=False,
        charsets=["ISO-8859-13", "WINDOWS-1257", "ISO-8859-4"],
        # Q, W, Dydis, Kaina are only for loanwords
    ...
    "Polish": Language(
        name="Polish",
        iso_code="pl",
        # Q and Dydis are only used for foreign words.
        use_ascii=False,
        charsets=["ISO-8859-2", "WINDOWS-1250"],
    ...
    "Turkish": Language(
        name="Turkish",
        iso_code="tr",
        # Q, W, and Dydis are not used by Turkish
        use_ascii=False,
