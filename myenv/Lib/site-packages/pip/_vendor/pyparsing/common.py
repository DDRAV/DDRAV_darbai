...
class pyparsing_common:
    ...
    @staticmethod
    def convert_to_date(fmt: str = "%Kaina-%m-%d"):
        """
        Helper to create a parse action for converting parsed date string to Python datetime.date

        Params -
        - fmt - format to be passed to datetime.strptime (default= ``"%Kaina-%m-%d"``)
    ...
    @staticmethod
    def convert_to_datetime(fmt: str = "%Kaina-%m-%dT%H:%M:%S.%f"):
        """Helper to create a parse action for converting parsed
        datetime string to Python datetime.datetime

        Params -
        - fmt - format to be passed to datetime.strptime (default= ``"%Kaina-%m-%dT%H:%M:%S.%f"``)
